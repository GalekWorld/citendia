...
const useCases = [
  {
    key: "clinicas",
    label: "Clinicas",
    title: "Cero llamadas perdidas en sala llena.",
    description:
      "Tu agente coge el telefono mientras las recepcionistas atienden a pacientes presenciales. Agenda, modifica y cancela citas segun las reglas de cada profesional.",
    bullets: [
      "Conexion con Doctoralia, IClinic o tu agenda interna",
      "Recordatorios automaticos por SMS y WhatsApp",
      "Lista de espera inteligente que rellena huecos"
    ]
  },
  {
    key: "restaurantes",
    label: "Restaurantes",
    title: "Reservas a cualquier hora, tambien los lunes.",
    description:
      "Mientras el equipo esta en sala, el agente toma reservas, gestiona alergias y avisa de eventos privados. Conectado con TheFork, CoverManager o tu sistema.",
    bullets: [
      "Integracion con TheFork y CoverManager",
      "Confirmacion por WhatsApp con menu adjunto",
      "Lista de espera y notificacion de cancelaciones"
    ]
  },
  {
    key: "inmobiliarias",
    label: "Inmobiliarias",
    title: "Cualifica leads a las 23:47 sin levantarte.",
    description:
      "Atiende llamadas de portales, hace las preguntas correctas, agenda visitas y registra cada lead en tu CRM con la cualificacion lista.",
    bullets: [
      "Idealista, Fotocasa, Habitaclia",
      "Cualificacion BANT automatica",
      "Volcado directo a HubSpot, Pipedrive o Salesforce"
    ]
  },
  {
    key: "despachos",
    label: "Despachos",
    title: "Filtra consultas, agenda mejor.",
    description:
      "Recoge la informacion esencial del caso, deriva al abogado correcto y agenda la primera consulta. Confidencialidad y tono profesional garantizados.",
    bullets: [
      "Cumplimiento RGPD",
      "Derivacion por especialidad",
      "Resumen del caso en email antes de la cita"
    ]
  },
  {
    key: "ecommerce",
    label: "Ecommerce",
    title: "Soporte 24/7 que tambien vende.",
    description:
      "Resuelve dudas de pedidos, cambios y devoluciones, y aprovecha cada conversacion para sugerir productos relacionados.",
    bullets: [
      "Shopify, WooCommerce, Prestashop",
      "Tracking de pedidos en directo",
      "Cross-sell y up-sell con tono natural"
    ]
  }
] as const;
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-[72px] w-full max-w-[1180px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-7 text-[14px] font-medium text-[#43516a] lg:flex">
          <a className="interactive-lift transition hover:text-[#1854ff]" href="#servicios">
            Servicios
          </a>
          <a className="interactive-lift transition hover:text-[#1854ff]" href="#casos-de-uso">
            Casos de uso
          </a>
          <a className="interactive-lift transition hover:text-[#1854ff]" href="#precios">
            Precios
          </a>
          <a className="interactive-lift transition hover:text-[#1854ff]" href="#contacto">
            Contacto
          </a>
        </nav>
        ...
        <div className="mx-auto w-full max-w-[500px] text-left lg:mx-0">
          ...
          <div className="mt-8 flex flex-col gap-3 text-[13px] text-[#7a879f] sm:flex-row sm:items-center sm:gap-6">
            <div className="flex items-center gap-3">
              ...
              Disponible 24/7 · 365 dias
            </div>
            <div className="flex items-center gap-3">
              <span className="h-2.5 w-2.5 rounded-full bg-[#1854ff]" />
              Castellano nativo y +20 idiomas
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-x-[66px] top-[50px] bottom-[42px] rounded-[32px] border border-[#dfe8f4] bg-[#fcfdff] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="mt-1 text-[18px] font-semibold tracking-[-0.04em] text-[#091126]">
                Resumen del cliente
              </h3>
            </div>
          ...
          <div className="mt-4 rounded-[18px] border border-[#e4ebf6] bg-white px-4 py-3">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-[12px] font-medium text-[#091126]">Lucia · Ashford House</p>
                <p className="mt-1 text-[12px] text-slate-500">
                  Voz, chat web y seguimiento mensual en un solo panel
                </p>
              </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="rounded-[18px] border border-[#e4ebf6] bg-white p-4">
              <p className="text-[11px] uppercase tracking-[0.18em] text-slate-400">Llamadas</p>
              <p className="mt-2 text-[24px] font-semibold tracking-[-0.05em] text-[#091126]">247</p>
              <p className="mt-1 text-[12px] text-slate-500">Este mes</p>
            </div>
            <div className="rounded-[18px] border border-[#e4ebf6] bg-white p-4">
              <p className="text-[11px] uppercase tracking-[0.18em] text-slate-400">Minutos</p>
              <p className="mt-2 text-[24px] font-semibold tracking-[-0.05em] text-[#091126]">812</p>
              <p className="mt-1 text-[12px] text-slate-500">Acumulados</p>
            </div>
            <div className="rounded-[18px] border border-[#e4ebf6] bg-white p-4">
              <p className="text-[11px] uppercase tracking-[0.18em] text-slate-400">Facturacion</p>
              <p className="mt-2 text-[24px] font-semibold tracking-[-0.05em] text-[#091126]">212,40 €</p>
              <p className="mt-1 text-[12px] text-slate-500">Estimada</p>
            </div>
            <div className="rounded-[18px] border border-[#2551f5] bg-[#2551f5] p-4 text-white">
              <p className="text-[11px] uppercase tracking-[0.18em] text-white/72">Pendientes</p>
              <p className="mt-2 text-[24px] font-semibold tracking-[-0.05em]">3</p>
              <p className="mt-1 text-[12px] text-white/82">Por revisar</p>
            </div>
          </div>
      ...
      <div className="overflow-hidden border-y border-slate-200/70">
        <div className="marquee-track flex min-w-max items-center gap-10 py-5">
          {items.map((client, index) => (
            <span
              className="whitespace-nowrap text-[16px] font-semibold tracking-[-0.04em] text-[#9aa7bd]"
              key={`${client}-${index}`}
            >
              {client}
            </span>
...
function ServicesSection() {
  const cards: Array<{
    ...
    description: string;
    pills: string[];
    icon: "phone" | "calendar" | "chat" | "shield";
  }> = [
    {
      title: "Llamadas IA",
      description:
        "Tu agente coge el telefono al instante, identifica la intencion del cliente y responde con voz natural en castellano.",
      pills: ["Latencia < 800 ms", "Voz natural", "Transferencia a humano"],
      icon: "phone"
    },
    {
      title: "Agendamiento automatico",
      description:
        "Reserva, modifica y cancela citas en tu calendario sin intervencion humana. Los recordatorios se envian solos.",
      pills: ["Google / Outlook", "Recordatorios SMS", "Lista de espera"],
      icon: "calendar"
    },
    {
      title: "Chat IA omnicanal",
      description:
        "Web, WhatsApp e Instagram con una misma personalidad. Una sola conversacion por cliente y el mismo contexto.",
      pills: ["WhatsApp Business", "Web embed", "Instagram DM"],
      icon: "chat"
    },
    {
      title: "Integraciones a tu CRM",
      description:
        "HubSpot, Pipedrive, Salesforce o Notion. Cada conversacion queda registrada donde ya trabaja tu equipo.",
      pills: ["API abierta", "Webhooks", "Zapier / Make"],
      icon: "shield"
    }
  ];
      ...
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="max-w-[660px] text-left">
          ...
          <h2 className="mt-4 text-[30px] font-semibold leading-[1.06] tracking-[-0.06em] text-[#071027] sm:text-[36px] lg:text-[40px]">
            Todo lo que un equipo humano
            <br />
            puede hacer al telefono. <span className="text-[#b9c3d4]">Sin descansos.</span>
          </h2>
          <p className="mt-5 max-w-[620px] text-[15px] leading-[1.65] text-[#55657f] sm:text-[16px]">
            Disenamos cada agente a la medida de tu negocio: tono de marca, procesos internos e
            integraciones. Tu lo lanzas, nosotros lo entrenamos.
          </p>
        </div>
...
function ServiceCard({
  ...
  return (
    <article className="interactive-lift rounded-[20px] border border-[#dbe3ef] bg-white px-5 py-5 shadow-[0_12px_36px_-30px_rgba(15,23,42,0.22)] hover:border-[#c9d7ec] hover:shadow-[0_22px_46px_-32px_rgba(15,23,42,0.28)] sm:px-6 sm:py-6">
      <div className="flex h-10 w-10 items-center justify-center rounded-[12px] bg-[#edf3ff] text-[#1854ff]">
        {icon === "phone" ? <Phone className="h-5 w-5" /> : null}
        {icon === "calendar" ? <CalendarDays className="h-5 w-5" /> : null}
        {icon === "chat" ? <MessageCircleMore className="h-5 w-5" /> : null}
        {icon === "shield" ? <ShieldCheck className="h-5 w-5" /> : null}
      </div>

      <h3 className="mt-5 text-[20px] font-semibold tracking-[-0.04em] text-[#091126]">{title}</h3>
      <p className="mt-3 max-w-[500px] text-[14px] leading-[1.65] text-[#56657e] sm:text-[15px]">{description}</p>

      <div className="mt-5 flex flex-wrap gap-2">
        {pills.map((pill) => (
          <span
            className="rounded-full bg-[#f2f5fa] px-3 py-1.5 text-[12px] font-medium text-[#5c6a83]"
            key={pill}
          >
            {pill}
          </span>
    ...
    <section className="section-divider bg-white px-4 py-20 sm:px-6 sm:py-24 lg:px-8" id="casos-de-uso">
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="max-w-[700px] text-left">
          ...
          <h2 className="mt-4 text-[30px] font-semibold leading-[1.06] tracking-[-0.06em] text-[#071027] sm:text-[36px] lg:text-[40px]">
            Pensado para sectores donde
            <br />
            <span className="text-[#aab6ca]">cada llamada importa.</span>
          </h2>
        </div>
    ...
    <section className="section-divider bg-white px-4 py-20 sm:px-6 sm:py-24 lg:px-8" id="precios">
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="max-w-[640px] text-left">
          ...
          <h2 className="mt-4 text-[30px] font-semibold leading-[1.06] tracking-[-0.06em] text-[#071027] sm:text-[36px] lg:text-[40px]">
            Planes claros. <span className="text-[#aab6ca]">IVA incluido.</span>
          </h2>
          <p className="mt-5 text-[15px] leading-[1.7] text-[#55657f] sm:text-[16px]">
            Sin permanencias absurdas. Cancela cuando quieras y manten siempre la propiedad de tus datos.
          </p>
        </div>
        ...
        <p className="mt-8 text-center text-[14px] text-[#7082a3]">
          No encuentras tu caso? Cuentanoslo y te diseniamos un plan a medida.
        </p>
      </div>
    </section>
  );
...
function PricingCard({
  ...
  return (
    <article
      className={`interactive-lift relative rounded-[26px] border px-7 py-7 ${
        isDark
          ? "border-[#0a0f24] bg-[#050918] text-white shadow-[0_30px_60px_-40px_rgba(5,9,24,0.8)] hover:shadow-[0_40px_80px_-42px_rgba(5,9,24,0.9)]"
          : "border-[#dbe3ef] bg-white text-[#071027] hover:border-[#c9d7ec] hover:shadow-[0_24px_48px_-34px_rgba(15,23,42,0.2)]"
      }`}
    >
      {badge ? (
      ...
      <p className={`text-[11px] font-semibold uppercase tracking-[0.28em] ${isDark ? "text-white/70" : "text-[#7082a3]"}`}>
        {name}
      </p>
      ...
      <p className={`mt-4 min-h-[52px] text-[15px] leading-[1.55] ${isDark ? "text-white/74" : "text-[#55657f]"}`}>
        {description}
      </p>
      ...
      <a
        className={`interactive-lift mt-10 inline-flex h-[54px] w-full items-center justify-center rounded-full px-6 text-[15px] font-semibold ${
          isDark ? "bg-white text-[#050918] hover:bg-slate-100" : "bg-[#050918] text-white hover:bg-[#111827]"
        }`}
        href={ctaHref}
      ...
      <div className="mx-auto grid w-full max-w-[1180px] gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div className="max-w-[380px] text-left">
          ...
          <p className="mt-6 text-[16px] leading-[1.7] text-white/74">
            Escribenos como es tu negocio y que te gustaria que automatizase tu agente. Te respondemos con una propuesta concreta en menos de 24h.
          </p>
        ...
        >
          ...
          <label className="mt-5 block text-left">
            <span className="mb-2 block text-[14px] font-medium text-[#091126]">Cuentanos tu caso *</span>
            <textarea
              ...
              placeholder="Que te gustaria que hiciera tu agente? Cuantas llamadas o chats al mes recibes?"
              value={form.message}
            />
          </label>

          <button
            className="interactive-lift mt-7 inline-flex h-[56px] w-full items-center justify-center gap-3 rounded-full bg-[#1854ff] px-6 text-[16px] font-semibold text-white hover:bg-[#0f46ea]"
            disabled={submitting}
            type="submit"
          >
          ...
          <p className="mt-4 text-center text-[13px] text-[#8b97ad]">
            Al enviar aceptas nuestra politica de privacidad. Nunca compartiremos tus datos.
          </p>
        </form>
      </div>
    </section>
      ...
      <div className="mx-auto grid w-full max-w-[1180px] gap-10 lg:grid-cols-[1.15fr_0.85fr_0.85fr_0.85fr]">
        <div className="max-w-[320px]">
          ...
          <p className="mt-5 text-[15px] leading-[1.7] text-white/70">
            Agentes de IA personalizados que cogen el telefono, agendan citas y atienden chats por ti. Hechos en Espana, para PYMES europeas.
          </p>
        </div>
        ...
        <FooterColumn
          items={[
            { label: "Acceder al portal", href: "/login" },
